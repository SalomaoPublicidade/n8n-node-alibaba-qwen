...
const modelOptionsDataDefinition = {
    paid: [
        ...
        { name: 'qwen-turbo-2024-11-01', value: 'qwen-turbo-2024-11-01' }, { name: 'qvq-max-2025-03-25', value: 'qvq-max-2025-03-25' },
    ],
    freeTrial: [
...
class QwenModel {
    constructor() {
        ...
        this.description = {
            ...
            inputs: [{ displayName: 'Input', required: true, type: "main" /* NodeConnectionType.Main */ }],
            outputs: [{ displayName: 'Output', type: "main" /* NodeConnectionType.Main */ }],
    ...
    async execute() {
        ...
        const returnItems = [];
        const clientIdentifier = 'n8n-node-qwen/1.0.3';
